...
_LINEAGE_REQUIRED_ROLE_KINDS = {
    ...
    "run_failure_analysis_json": "failure_analysis",
    "run_research_replan_json": "research_replan",
    ...
    "run_literature_graph_json": "literature_graph",
    "run_novelty_validation_json": "novelty_validation",
