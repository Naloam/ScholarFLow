...
def build_publication_evidence_index(
    ...
    *,
    ...
    items = [
        ...
        _item(
            evidence_id="experiment_design",
            label="Experiment design",
            category="design",
            role="run_experiment_design_json",
            path=review.experiment_design_path or (base / EXPERIMENT_DESIGN_FILENAME),
            required_for_final_publish=True,
            supports=[
                "baseline selection",
                "ablation coverage",
        ...
        _item(
            ...
            path=review.failure_analysis_path or (base / FAILURE_ANALYSIS_FILENAME),
            required_for_final_publish=True,
            supports=[
        ...
        _item(
            evidence_id="research_replan",
            label="Research replan",
            category="replan",
            role="run_research_replan_json",
            path=review.research_replan_path or (base / RESEARCH_REPLAN_FILENAME),
            required_for_final_publish=True,
            supports=[
                "hypothesis repair",
                "task scope adjustment",
                "baseline additions",
                "ablation additions",
                "rerun plan",
            ],
